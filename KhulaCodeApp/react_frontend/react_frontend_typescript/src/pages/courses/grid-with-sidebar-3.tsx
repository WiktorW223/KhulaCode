...
export default function GridWithSidebar3() {
  return (
    <>
        <NavDark/>
                        ...
                        <div className="breadcrumb m-0">
                            <nav aria-label="breadcrumb">
                                <ol className="breadcrumb simple light">
                                    ...
                                    <li className="breadcrumb-item active" aria-current="page">Courses Layout 03</li>
                                </ol>
                            </nav>
                        </div>
                        <div className="pageTitle-wrap">
                            <h1 className="text-light">Courses Layout 03</h1>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div className="row">
                    ...
                    <div className="col-xxl-9 col-lg-8 col-12">
                        ...
                        <div className="row g-xl-3 g-4 mb-5">
                            {freeCoursesData.slice(0,9).map((item:CoursesData,index:number)=>(
                                <div className="col-xxl-4 col-xl-6 col-lg-6 col-md-6" key={index}>
