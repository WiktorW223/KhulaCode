...
export default function GridWithSidebar() {
  return (
    <>
        <NavDark/>
                        ...
                        <div className="breadcrumb m-0">
                            <nav aria-label="breadcrumb">
                                <ol className="breadcrumb simple light">
                                    ...
                                    <li className="breadcrumb-item active" aria-current="page">Course with Sidebar</li>
                                </ol>
                            </nav>
                        </div>
                        <div className="pageTitle-wrap">
                            <h1 className="text-light">Courses with Sidebar</h1>
                        </div>
                    </div>
                </div>
            </div>
