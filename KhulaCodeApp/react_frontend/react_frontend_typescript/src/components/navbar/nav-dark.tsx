                    ...
                    <div className={`nav-menus-wrapper ${toggle ? 'nav-menus-wrapper-open' : ''}`}> 
                        ...
                        <ul className="nav-menu nav-menu-social align-to-right">
                            {/* <li className="become-tutor">
                                <Link to="/student-dashboard"><i className="bi bi-person-circle"></i>{access?"Profile":"Become a Tutor"}</Link>
                            </li> */}
                            <li className="join-btn">
                                <Link to="/register?tab=signin" ><i className={access?"bi bi-play-circle me-2":"bi bi-box-arrow-in-right"}></i>{access?"Resume Lessons":"Sign In"}</Link>
                            </li>
                        </ul>
                    </div>
                </nav>
