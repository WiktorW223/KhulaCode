...
from . import views
from .views import Register, ForgotPassword, TokenView, LessonDetailView, get_profile_info, get_many_lessons, make_lesson, mark_activity_complete,mark_video_complete,get_most_recent,get_num_lesson_unit,get_all_students, curriculum,get_schools
