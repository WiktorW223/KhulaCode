...
export default function FullWidthCourse4() {
  return (
    <>
        <NavDark/>
                        ...
                        <div className="breadcrumb m-0">
                            <nav aria-label="breadcrumb">
                                <ol className="breadcrumb simple">
                                    ...
                                    <li className="breadcrumb-item active" aria-current="page">Course Full Layout 04</li>
                                </ol>
                            </nav>
                        </div>
                        <div className="pageTitle-wrap">
                            <h1 className="text-dark">Courses Full Layout 04</h1>
                        </div>
                    </div>
                </div>
            </div>
