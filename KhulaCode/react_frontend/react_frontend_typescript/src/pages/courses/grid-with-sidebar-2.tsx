...
export default function GridWithSidebar2() {
  return (
    <>
        <NavDark/>
                        ...
                        <div className="breadcrumb m-0">
                            <nav aria-label="breadcrumb">
                                <ol className="breadcrumb simple light">
                                    ...
                                    <li className="breadcrumb-item active" aria-current="page">Courses Layout 02</li>
                                </ol>
                            </nav>
                        </div>
                        <div className="pageTitle-wrap">
                            <h1 className="text-light">Courses Layout 02</h1>
                        </div>
                    </div>
                </div>
            </div>
