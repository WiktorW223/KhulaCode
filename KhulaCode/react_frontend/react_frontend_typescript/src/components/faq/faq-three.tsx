import bg from '../../assets/img/custom-img-5.png'
                        ...
                        <div id="supportingExample" className="accordion supporting">
                            ...
                            <div className="card border shadow-0 mb-3">
                                <div id="headingOne" className="card-header">
                                    <h6 className="mb-0 accordion_title"><a href="#" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne" className="d-block position-relative text-dark  fw-semibold collapsible-link py-2">Free Vs Premium Courses</a></h6>
                                </div>
                                <div id="collapseOne" aria-labelledby="headingOne" data-parent="#supportingExample" className="collapse show">
                                    <div className="card-body text-muted p-3">
                            ...
                            <div className="card border shadow-0 mb-3">
                                <div id="headingTwo" className="card-header">
                                    <h6 className="mb-0 accordion_title"><a href="#" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo" className="d-block position-relative collapsed text-dark  fw-semibold collapsible-link py-2">Advance in Membership Plan?</a></h6>
                                </div>
                            ...
                            <div className="card border shadow-0 mb-3">
                                <div id="headingThree" className="card-header">
                                    <h6 className="mb-0 accordion_title"><a href="#" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree" className="d-block position-relative collapsed text-dark  fw-semibold collapsible-link py-2">High Value Supporting</a></h6>
                                </div>
